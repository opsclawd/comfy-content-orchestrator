...
- The legacy `LTX_25_720P_5S_V1` profile remains strictly unconditioned text-to-video, retained only for explicitly legacy/non-conditioned callers. Normal reviewed production dispatches `LTX_25_720P_5S_I2V_V1` by default and requires approved candidate conditioning.
