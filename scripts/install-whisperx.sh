...
if [[ -z "${WHISPERX_PIP_VERSION:-}" || -z "${WHISPERX_TORCHAUDIO_VERSION:-}" || -z "${WHISPERX_VENV_DIR:-}" || -z "${WHISPERX_MODEL_DIR:-}" || -z "${WHISPERX_ALIGNMENT_MODEL_ID:-}" || -z "${WHISPERX_ALIGNMENT_MODEL_REVISION:-}" || -z "${WHISPERX_ALIGNMENT_MODEL_FILE:-}" || -z "${WHISPERX_ALIGNMENT_MODEL_SHA256:-}" || -z "${WHISPERX_ALIGNMENT_MODEL_URL:-}" ]]; then
  echo "Error: .whisperx-version must define WHISPERX_PIP_VERSION, WHISPERX_TORCHAUDIO_VERSION, WHISPERX_VENV_DIR, WHISPERX_MODEL_DIR, WHISPERX_ALIGNMENT_MODEL_ID, WHISPERX_ALIGNMENT_MODEL_REVISION, WHISPERX_ALIGNMENT_MODEL_FILE, WHISPERX_ALIGNMENT_MODEL_SHA256, and WHISPERX_ALIGNMENT_MODEL_URL" >&2
  exit 1
fi
...
echo "Upgrading pip and installing whisperx==${WHISPERX_PIP_VERSION} torchaudio==${WHISPERX_TORCHAUDIO_VERSION}..."
"${PIP_BIN}" install --upgrade pip
"${PIP_BIN}" install "whisperx==${WHISPERX_PIP_VERSION}" "torchaudio==${WHISPERX_TORCHAUDIO_VERSION}"
